...
public class MentionHistoryPanel extends PluginPanel
{
    ...
    private final List<FavoriteLabelBinding> favoriteLabels =
            new ArrayList<>();
            ...
            MentionHistoryEntry entry)
    {
        ...
        final FavoriteLabelBinding favoriteBinding =
                new FavoriteLabelBinding(
                        senderLabel,
                        sender,
                        senderLabel.getForeground());
    ...
    public void refreshFavoriteAppearance()
    {
        ...
        {
            SwingUtilities.invokeLater(
                    this::refreshFavoriteAppearance);
            return;
        }
            ...
            FavoriteLabelBinding binding)
    {
        ...
        final Color favoriteColor =
                config != null
                        && config.favoriteColor() != null
                        ? config.favoriteColor()
                        : new Color(255, 205, 70);

        binding.label.setForeground(
                favorite
                        ? favoriteColor
                        : binding.normalColor);
    }
