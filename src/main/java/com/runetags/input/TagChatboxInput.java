 ...
 */
public final class TagChatboxInput extends ChatboxInput implements KeyListener, MouseListener {
	...
	public TagChatboxInput(ChatboxPanelManager chatboxPanelManager, ClientThread clientThread) {
